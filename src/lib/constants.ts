...
export const MOCK_SUPPLIERS = [
  ...
  {
    id: "s5", business_name: "Nova Health Services", country: "United States",
    industry_codes: ["62"], category_codes: ["85000000"],
    designations: ["Women-Owned","Minority-Owned"], cert_type: "digital" as const,
    cert_status: "active" as const, trust_score: 96, blockchain_verified: true,
    women_owned: true,
  },
  {
    id: "s6", business_name: "Bright Futures Education", country: "India",
    industry_codes: ["61"], category_codes: ["86000000"],
    designations: ["Women-Led Business","Small Business"], cert_type: "self" as const,
    cert_status: "pending" as const, trust_score: 72, blockchain_verified: false,
    women_owned: true,
  },
];
